    ...
    public class ExternalLogin
    {
        ...
        public class Handler : IRequestHandler<Query, User>
        {
            ...
            public async Task<User> Handle(Query request, CancellationToken cancellationToken)
            {
                ...
                if (userInfo == null)
                    new RestException(HttpStatusCode.BadRequest, new { User = "Problem validating token" });
                ...
                if (user == null)
                {
                    ...
                    if (!result.Succeeded)
                        new RestException(HttpStatusCode.BadRequest, new { User = "Problem creating user" });
                }
